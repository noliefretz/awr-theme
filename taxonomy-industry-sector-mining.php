...
<div id="intro" class="industryCat mining nfmParaReverse">
    <div class="overlay">
        <div class="container">

            <h2>Commercial Mining Supply</h2>
            <h3>Shop our <strong class="stroke-three mining">mining</strong> products online. Speedy shipping <strong class="stroke-two">worldwide</strong>.</h3>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <h3>Mining put Alaska on the map over 100 years ago with the gold rush in Nome.</h3>

                    <p>Today we have added copper, zinc and coal to the mix but most of these sites are remote so creative freight solutions is one of our specialties.
If you are going to pay more in shipping than the cost of the product, buying quality lifting &amp; rigging products that last is worth it.</p>
