            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-md-9">
                    ...
                    <div id="itemGrid">
                        ...
                        <div class="head">
                            <ul>
                                <li><strong>Anchors</strong> 1-6 of 6</li>
                                <li>
                        ...
                        <?php
                            ...
                            $this_category_id = $category->term_id;
                            ...
                            wpse_modify_category_query($the_query);
                                                ...
                                                <div class="col-xs-3">
                                                    <div class="thumb">
                                                        <a href="'.get_the_permalink().'">
                                                            <img src="'.get_template_directory_uri() .'/images/product03.png" alt="">
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6">
                                        ...
                                        $display = '
                                            <div class="row">
                                                <div class="col-xs-3">
                                                    <div class="thumb">
                                                        <a href="'.get_the_permalink().'">
                                                            <img src="'.get_template_directory_uri() .'/images/product03.png" alt=""></div>
                                                        </a>
                                                </div>
                                                <div class="col-xs-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <ul class="pagination2">
                                        ...
                                        ?>
                                        <li><a href="<?php echo bloginfo('url') . $toTop; ?>">back to top</a></li>
                                        <li>
